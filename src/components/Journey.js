...
export default function Journey() {
    ...
    return (
        <section id="journey" className="py-20 bg-navy-900 text-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col lg:flex-row gap-12 items-center">
                    <div className="lg:w-1/2">
                        <div className="inline-flex items-center gap-2 bg-navy-800 px-4 py-2 rounded-full text-navy-200 text-sm font-bold mb-6">
                            <Milestone size={18} />
                            PERSONAL JOURNEY
                        </div>
                    ...
                    <div className="lg:w-1/2 w-full grid grid-cols-2 gap-4">
                        <div className="bg-navy-800/50 h-40 rounded-2xl border border-navy-700/50 flex items-center justify-center text-navy-300 italic">
                            Childhood Story
                        </div>
                        <div className="bg-navy-800/50 h-40 rounded-2xl border border-navy-700/50 mt-8 flex items-center justify-center text-navy-300 italic">
                            Self Learning
                        </div>
                        <div className="bg-navy-800/50 h-40 rounded-2xl border border-navy-700/50 flex items-center justify-center text-navy-300 italic">
                            Observation
