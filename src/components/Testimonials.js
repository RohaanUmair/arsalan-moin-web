...
/**
 * Testimonials - Client Component (drag carousel functionality)
 * SEO text is still rendered but wrapped in client for drag animations
 */
            ...
            <div className="w-full">
                ...
                <div className="pl-6 md:pl-[max(2rem,calc((100vw-1280px)/2))] overflow-hidden">
                    ...
                    >
                        ...
                        {/* Card 3 - Simple Quote */}
                        <div className="min-w-[300px] md:min-w-[400px] relative group overflow-hidden bg-navy-100 rounded-sm flex items-center justify-center p-10">
                            <div className="text-center">
                                <p className="text-cream-900 text-xl font-serif font-medium mb-4">"Life changing content."</p>
                                <div className="flex gap-1 justify-center">
                                    {[1, 2, 3, 4, 5].map(i => <div key={i} className="w-3 h-[1px] bg-navy-400" />)}
                                </div>
                            </div>
                        </div>
